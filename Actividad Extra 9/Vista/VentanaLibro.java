...
public class VentanaLibro extends JFrame
{
    ...
    public VentanaLibro(String title) throws HeadlessException
    {
        ...
        panel1.setBackground(new Color(189, 145, 145));
        lblID = new JLabel("ID: ");
        ...
        panel2.setBackground(new Color(108, 153, 169));
        ...
        panel3.setBackground(new Color(114, 162, 135));

        //Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(117, 106, 140));
